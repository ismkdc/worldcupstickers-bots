...
var products = []Product{
	{30000037458885, "37458885", "Çoklu Çıkartma Worldcup26", "https://www.macrocenter.com.tr/turkuvaz-dagitim-coklu-cikrt-worldcup26-p-23b93c5"},
	{30000037457979, "37457979", "Süper Çoklu Worldcup 2026", "https://www.macrocenter.com.tr/super-cokluworldcup-2026-p-23b903b"},
	{30000037458884, "37458884", "Çıkartma Albüm Worldcup26", "https://www.macrocenter.com.tr/cikrt-album-worldcup26-p-23b93c4"},
	{30000037457978, "37457978", "Çıkartma Paketi Worldcup 2026", "https://www.macrocenter.com.tr/ckrt-pakt-worldcup-2026-p-23b903a"},
}
...
const base = "https://www.macrocenter.com.tr/rest"
...
func main() {
	...
	hb.WriteString("🟢 MacroCenter stok botu ayakta — çalışıyor.\n🧩 İzlenen ürünler:")
	for _, p := range products {
		hb.WriteString("\n   • " + p.Name)
	}
	...
	for {
		...
		if !state.StartupNotified {
			...
			if len(byProd) > 0 {
				sendTelegram(fmt.Sprintf("✅ MacroCenter ilk tarama tamam — %d mağaza × %d ürün. Şu an stoktaki ürünler aşağıda 👇", total, len(products)))
				for _, p := range products {
				...
				sendTelegram(fmt.Sprintf("✅ MacroCenter ilk tarama tamam — %d mağaza × %d ürün tarandı, şu an hiçbirinde stok yok. Stok geldikçe buraya yazacağım.", total, len(products)))
			}
			for pp, r := range results {
				for short, pr := range r.Products {
					if pr.Status == "IN_SALE" {
